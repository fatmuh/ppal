...
<body>
	<div id="imgDiv" style="width: 1003px; height: 661px">
		...
		<p class="foto"><img src="https://kta.ppal.or.id/ppal/{{ $data->foto }}" width="199px" height="301px"></p>
		...
		<p class="ttd"><b><img src="/get-image?image={{ $data->foto }}" width="199px" height="301px"></b></p>
	</div>
