...
<body>
	<div id="imgDiv" style="width: 1003px; height: 661px">
		...
		<p class="foto"><img src="https://kta.picode.dev/ppal/{{ $data->foto }}" width="199px" height="301px"></p>
		<p class="bar128"><img src='http://kta.picode.dev/barcode.php?codetype=code128&sizefactor=1&size=50&text={{ $data->no_kta }}'/></p>
		<p class="tanggal"><b>{{ $data->tanggal_cetak }}</b></p>
		<p class="ttd"><b><img src="https://kta.picode.dev/ppal/{{ $data->ttd }}"></b></p>
	</div>
